                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 20 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginTop: 2 }}>
                      Cantidad total de incidencias que se resolvieron hoy
                    </div>
                  </div>
                </div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
                    <button
                      onClick={() =>
                        setForm((f) => ({
                          ...f,
                          incidencias_resueltas: Math.max(0, f.incidencias_resueltas - 1),
                        }))
                      }
                      style={{
                        width: 52,
                    ...
                    <button
                      onClick={() =>
                        setForm((f) => ({
                          ...f,
                          incidencias_resueltas: f.incidencias_resueltas + 1,
                        }))
                      }
                      style={{
                        width: 52,
                      ...
                      onMouseLeave={(e) => {
                        e.currentTarget.style.background =
                          form.incidencias_resueltas > 0 ? color + '22' : 'var(--bg-elevated)'
                        e.currentTarget.style.borderColor =
                          form.incidencias_resueltas > 0 ? color + '66' : 'var(--border)'
                      }}
                    >
                      +
                    </button>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginTop: 2 }}>
                      Cada campo se actualiza de forma independiente durante el día
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <span style={{ fontSize: '0.8rem', color: 'var(--text-secondary)' }}>
                    ...
                    <strong style={{ color: 'var(--text-primary)' }}>
                      {new Date(getPeriodo(selectedDate)).toLocaleDateString('es-AR', {
                        month: 'long',
                        year: 'numeric',
                      })}
                    </strong>
                  ...
                  {[
                    ...
                    <div key={f.key}>
                      ...
                      <input
                        ...
                        style={{
                          ...inputSt,
                          borderColor: ga4[f.key] ? f.color + '44' : 'var(--border)',
                        }}
                      />
                    </div>
                  ))}
                        ...
                        >
                          ...
                          <span
                            style={{
                              ...
                              fontWeight: 600,
                              color:
                                parseInt(kw.posicion) <= 3
                                  ? '#10b981'
                                  : parseInt(kw.posicion) <= 10
                                  ? color
                                  : 'var(--text-secondary)',
                            }}
                          >
