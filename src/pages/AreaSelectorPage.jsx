...
function PinInput({ area, onSuccess, onCancel }) {
  ...
  async function handleSubmit(e) {
    ...
    setLoading(true)
    const result = await validatePin(area.area_key, pin)
    setLoading(false)
    if (result) {
      selectArea(result)
          ...
          {areas.map((area, i) => (
            <button
              ...
              onMouseEnter={e => {
                ...
                e.currentTarget.style.borderColor = area.color + '66'
                e.currentTarget.style.boxShadow = `0 12px 40px ${area.color}18`
              }}
              onMouseLeave={e => {
              ...
              <div style={{
                ...
                {[0,1,2,3].map(d => (
                  <div key={d} style={{
                    ...
                    border: `1.5px solid ${area.color}88`,
                  }} />
                ))}
                <span style={{
                  marginLeft: 4,
